<template>
  <svg id="icon" fill="#000000" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect id="_Transparent_Rectangle_" class="cls-1" data-name="&lt;Transparent Rectangle&gt;" height="32" width="32"/>
  </svg>
</template>
